...
public class GeoLocator {
    ...
    public GeoLocator(GeometryFactory geometryFactory) {
     ...
     *
     * @param areas collection of areas at the location
     * @param x coordinate
     * @param y coordinate
     ...
     */
    public List<String> locateAreas(Collection<NamedArea> areas, double x, double y) {
